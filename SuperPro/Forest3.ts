...
class calf extends cow
{
    ...
    family(Color : string) : void   //non-static method without returntype and with one argument
    {
        ...
        console.log("With THIS  C -> myColor is : " +this.Color);   //using "this" we exclusivley access instance child variable
        //console.log("With SUPER -> P  myColor is : " +super.Color);   //using "super" we exclusivley access instance parent variable
